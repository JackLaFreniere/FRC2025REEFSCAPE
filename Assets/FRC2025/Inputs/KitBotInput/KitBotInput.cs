...
//     version 1.14.0
//     from Assets/FRC2025/Inputs/KitBotInput/KitBotInput.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/FRC2025/Inputs/KitBotInput/KitBotInput.inputactions".
/// </summary>
/// <remarks>
...
/// </code>
/// </example>
public partial class @KitBotInput: IInputActionCollection2, IDisposable
{
    /// <summary>
    ...
    ~@KitBotInput()
    {
        UnityEngine.Debug.Assert(!m_Player.enabled, "This will cause a leak and performance issues, KitBotInput.Player.Disable() has not been called.");
        UnityEngine.Debug.Assert(!m_UI.enabled, "This will cause a leak and performance issues, KitBotInput.UI.Disable() has not been called.");
    }
    ...
    {
        private @KitBotInput m_Wrapper;

        /// <summary>
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public PlayerActions(@KitBotInput wrapper) { m_Wrapper = wrapper; }
        /// <summary>
    ...
    public struct UIActions
    {
        ...
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public UIActions(@KitBotInput wrapper) { m_Wrapper = wrapper; }
        /// <summary>
