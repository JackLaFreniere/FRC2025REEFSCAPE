namespace FRC2025
{
    ...
    public class MukwonagoBotConfirmCoralScoreState : PlayerState
    {
        ...
        {
            if (bot.shoulder.IsAtTargetRotation() && bot.elbow.IsAtTargetRotation() && bot.elevator.IsAtTargetPosition() && bot.wrist.IsAtTargetRotation() && _baseRobot.hasCoral)
            {
                bot.wrist.GetComponentInChildren<CoralIntakeZone>().EjectCoral();
            }
        }
